          ...
          <div class="m-auto space-y-8 sm:w-4/5 md:w-3/5 xl:w-2/5">
            <div class="p-8 md:py-12">
              <img
                ...
                alt="tailus logo"
              />
              <h2 class="mt-20 mb-8 text-3xl font-bold text-gray-800 dark:text-white">
                ...
                <div class="space-y-4">
                  ...
                  <div class="relative flex items-center">
                    ...
                    <div class="absolute right-1">
                      ...
                      >
                        <span class="hidden relative text-base font-semibold text-white dark:text-gray-900 sm:block">
                          Next
                        </span>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
